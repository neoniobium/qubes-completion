...
function _qvm_features() {
    ...
    if (( QB_alone_args_count == 1 )); then
        ...
        __complete_string "${vm_common_features} ${vm_service_features} ${vm_rpc_features} ${vm_template_features} ${whonix_features}"
        return 0
    fi
