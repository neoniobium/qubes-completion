...
# This file is intended as an opt-in developer/test helper.
# By default it should NOT enable debug logging for users who install the completion package.
# To enable debug mode, copy this file to the installation directory (next to qubes-completion.sh)
# and set QB_DEBUG_MODE=1 here, or create your own override file and export QB_DEBUG_OVERRIDE_FILE environment
# variable pointing to it. This avoids surprising users with debug logs enabled by default.

# Default: debug off
QB_DEBUG_MODE=0

# Example: enable debug by changing the value above to 1 and editing paths below.
